  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      builder: (context, state) => state.loadingStatus ==
              LoadingMovieDetailStatus.success
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 24.0),
                            MovieMediaWidget(
                              posterList: state.moviePosters ?? [],
                              backdropList: state.movieBackdrops ?? [],
          ...
          : state.loadingStatus == LoadingMovieDetailStatus.failure
              ? const WidgetError()
              : const LoadingDataWidget(viewType: LoadingViewType.movieDetail),
    );
  }
